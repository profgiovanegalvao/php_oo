<?php
	...
	try {
			...
			$mail->Username   = 'desenvolvimentocamporeal@gmail.com';                     //SMTP username
			$mail->Password   = 'girqiiupvofspojb';                               //SMTP password
			$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
			$mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

			//Recipients
			$mail->setFrom('desenvolvimentocamporeal@gmail.com', 'Desenvolvimento Web Remetente');
